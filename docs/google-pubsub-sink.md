...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-google-pubsub/releases/download/v2.9.1.3/pulsar-io-google-pubsub-2.9.1.3.nar).
